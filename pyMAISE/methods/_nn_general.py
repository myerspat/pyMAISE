...
class DenseLayerHyperModel(HyperModel):
    ...
    def build(self, hp):
        ...
        if isinstance(self._num_nodes, list):
            num_nodes = hp.Int("Units", min_value= self._num_nodes[0], max_value=self._num_nodes[1], step=self._num_nodes[2])
        else:
...
class nnHyperModel(HyperModel):
    ...
    def __init__(self, structural_hyperparameters: dict = None, optimizer_hyperparameters: dict = None):
    ...
    def build(self, hp):
        ...
        for key in self._structural_hyperparameters["structural_hyperparameters"].keys():
            ...
            layer = DenseLayerHyperModel(self._structural_hyperparameters["structural_hyperparameters"][str(key)])
